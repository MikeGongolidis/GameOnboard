...
socket.onopen = function(event){
  ...
  if (params.has("mtype") && params.has("room_id") && params.has("game_type")) {
    ...
    window.location.replace("http://http://gameonboard-frontend.s3-website.eu-central-1.amazonaws.com/index.html");
  }
};


document.getElementById("back").addEventListener("click", function () {
  location.href = "http://http://gameonboard-frontend.s3-website.eu-central-1.amazonaws.com/index.html";
});
